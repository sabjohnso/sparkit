...
namespace sparkit::data::detail
{
  ...
  Block_sparse_row_sparsity::Impl::Impl(
    Shape shape,
  ...
  Shape
  Block_sparse_row_sparsity::Impl::shape() const { return shape_; }
  ...
  size_type
  Block_sparse_row_sparsity::Impl::block_rows() const { return block_rows_; }

  size_type
  Block_sparse_row_sparsity::Impl::block_cols() const { return block_cols_; }

  size_type
  Block_sparse_row_sparsity::Impl::num_block_rows() const { return num_block_rows_; }

  size_type
  Block_sparse_row_sparsity::Impl::num_block_cols() const { return num_block_cols_; }
  ...
  Block_sparse_row_sparsity::Impl::row_ptr() const { return row_ptr_; }

  std::span<size_type const>
  Block_sparse_row_sparsity::Impl::col_ind() const { return col_ind_; }
