...
namespace sparkit::data::detail
{
  ...
  Shape
  Compressed_row_sparsity::Impl::shape() const { return shape_; }
  ...
  Compressed_row_sparsity::Impl::row_ptr() const { return row_ptr_; }

  std::span<size_type const>
  Compressed_row_sparsity::Impl::col_ind() const { return col_ind_; }
