...
namespace sparkit::data::detail
{
  ...
  Shape
  Diagonal_sparsity::Impl::shape() const { return shape_; }

  size_type
  Diagonal_sparsity::Impl::size() const { return total_size_; }

  std::span<size_type const>
  Diagonal_sparsity::Impl::offsets() const { return offsets_; }
