...
namespace sparkit::data::detail
{
  ...
  Shape
  Ellpack_sparsity::Impl::shape() const { return shape_; }

  size_type
  Ellpack_sparsity::Impl::size() const { return total_size_; }

  size_type
  Ellpack_sparsity::Impl::max_nnz_per_row() const { return max_nnz_per_row_; }

  std::span<size_type const>
  Ellpack_sparsity::Impl::col_ind() const { return col_ind_; }
