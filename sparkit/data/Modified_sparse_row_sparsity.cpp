...
namespace sparkit::data::detail
{
  ...
  Modified_sparse_row_sparsity::Modified_sparse_row_sparsity(
    ...
    : Modified_sparse_row_sparsity(shape, std::vector<Index>(begin(input), end(input)))
  {}
  ...
  Modified_sparse_row_sparsity::operator=(Modified_sparse_row_sparsity const& input)
  {
    if (this != &input) {
      delete pimpl;
      pimpl = new Impl(*input.pimpl);
  ...
  Modified_sparse_row_sparsity&
  Modified_sparse_row_sparsity::operator=(Modified_sparse_row_sparsity&& input)
  {
    if (this != &input) {
      delete pimpl;
      pimpl = input.pimpl;
