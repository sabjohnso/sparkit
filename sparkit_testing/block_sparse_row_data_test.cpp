...
namespace sparkit::testing {
  ...
  TEST_CASE(
    "block_sparse_row_sparsity - construction_basic",
  ...
  TEST_CASE(
    "block_sparse_row_sparsity - construction_empty",
    "[block_sparse_row_sparsity]") {
  ...
  TEST_CASE(
    "block_sparse_row_sparsity - row_ptr_and_col_ind_structure",
    "[block_sparse_row_sparsity]") {
  ...
  TEST_CASE(
    "block_sparse_row_sparsity - duplicate_indices_collapsed",
    "[block_sparse_row_sparsity]") {
  ...
  TEST_CASE(
    "block_sparse_row_sparsity - non_divisible_dimensions",
    "[block_sparse_row_sparsity]") {
  ...
  TEST_CASE(
    "block_sparse_row_sparsity - copy_construction",
    "[block_sparse_row_sparsity]") {
  ...
  TEST_CASE(
    "block_sparse_row_sparsity - move_construction",
    "[block_sparse_row_sparsity]") {
    Block_sparse_row_sparsity original{
      Shape{4, 4}, 2, 2, {Index{0, 0}, Index{2, 2}}};
