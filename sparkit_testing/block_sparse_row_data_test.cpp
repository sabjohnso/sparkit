...
namespace sparkit::testing {
  ...
  TEST_CASE("block_sparse_row_sparsity - construction_basic", "[block_sparse_row_sparsity]")
  {
    // 4x4 matrix, 2x2 blocks, entries in block (0,0) and block (1,1)
    Block_sparse_row_sparsity bsr{Shape{4, 4}, 2, 2,
      {Index{0, 0}, Index{0, 1}, Index{1, 0}, Index{1, 1},
       Index{2, 2}, Index{2, 3}, Index{3, 2}, Index{3, 3}}};
  ...
  TEST_CASE("block_sparse_row_sparsity - construction_empty", "[block_sparse_row_sparsity]")
  {
  ...
  TEST_CASE("block_sparse_row_sparsity - row_ptr_and_col_ind_structure", "[block_sparse_row_sparsity]")
  {
    ...
    Block_sparse_row_sparsity bsr{Shape{4, 6}, 2, 2,
      {Index{0, 0}, Index{0, 1}, Index{1, 0}, Index{1, 1},
       Index{0, 4}, Index{0, 5}, Index{1, 4}, Index{1, 5},
       Index{2, 2}, Index{2, 3}, Index{3, 2}, Index{3, 3}}};
  ...
  TEST_CASE("block_sparse_row_sparsity - duplicate_indices_collapsed", "[block_sparse_row_sparsity]")
  {
    // Same block touched twice
    Block_sparse_row_sparsity bsr{Shape{4, 4}, 2, 2,
      {Index{0, 0}, Index{0, 1}, Index{0, 0}}};
  ...
  TEST_CASE("block_sparse_row_sparsity - non_divisible_dimensions", "[block_sparse_row_sparsity]")
  {
    // 5x5 matrix with 2x2 blocks: 3 block rows, 3 block cols
    // (last block row/col only partially filled)
    Block_sparse_row_sparsity bsr{Shape{5, 5}, 2, 2,
      {Index{0, 0}, Index{4, 4}}};
  ...
  TEST_CASE("block_sparse_row_sparsity - copy_construction", "[block_sparse_row_sparsity]")
  {
    Block_sparse_row_sparsity original{Shape{4, 4}, 2, 2,
      {Index{0, 0}, Index{2, 2}}};
  ...
  TEST_CASE("block_sparse_row_sparsity - move_construction", "[block_sparse_row_sparsity]")
  {
    Block_sparse_row_sparsity original{Shape{4, 4}, 2, 2,
      {Index{0, 0}, Index{2, 2}}};
  ...
  TEST_CASE("conversions - csr_bsr_roundtrip", "[conversions]")
  {
    ...
    Compressed_row_sparsity original{Shape{4, 4},
