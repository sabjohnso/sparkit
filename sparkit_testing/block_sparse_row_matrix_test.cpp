...
namespace sparkit::testing {
  ...
  TEST_CASE("block_sparse_row_matrix - construction_from_entries", "[block_sparse_row_matrix]")
  {
    Block_sparse_row_matrix<double> mat{Shape{4, 4}, 2, 2, {
  ...
  TEST_CASE("block_sparse_row_matrix - element_access", "[block_sparse_row_matrix]")
  {
    Block_sparse_row_matrix<double> mat{Shape{4, 4}, 2, 2, {
      {Index{0, 0}, 1.0}, {Index{0, 1}, 2.0},
      {Index{1, 0}, 3.0}, {Index{1, 1}, 4.0},
