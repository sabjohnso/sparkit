...
namespace sparkit::testing {
  ...
  TEST_CASE("compressed_column_matrix - construction_and_accessors", "[compressed_column_matrix]")
  {
  ...
  TEST_CASE("compressed_column_matrix - structural_accessors_delegate", "[compressed_column_matrix]")
  {
    Compressed_column_sparsity sp{Shape{6, 5},
      {Index{2, 2}, Index{4, 2}, Index{5, 3}}};
  ...
  TEST_CASE("compressed_column_matrix - sparsity_accessor", "[compressed_column_matrix]")
  {
    Compressed_column_sparsity sp{Shape{6, 5},
      {Index{2, 2}, Index{5, 3}}};
  ...
  TEST_CASE("compressed_column_matrix - empty_matrix", "[compressed_column_matrix]")
  {
  ...
  TEST_CASE("compressed_column_matrix - element_access_existing", "[compressed_column_matrix]")
  {
    Compressed_column_sparsity sp{Shape{6, 5},
      {Index{2, 2}, Index{4, 2}, Index{5, 3}}};
  ...
  TEST_CASE("compressed_column_matrix - element_access_absent_in_populated_column", "[compressed_column_matrix]")
  {
    Compressed_column_sparsity sp{Shape{6, 5},
      {Index{2, 2}, Index{4, 2}, Index{5, 3}}};
  ...
  TEST_CASE("compressed_column_matrix - element_access_empty_column", "[compressed_column_matrix]")
  {
    Compressed_column_sparsity sp{Shape{6, 5},
      {Index{2, 2}, Index{5, 3}}};
  ...
  TEST_CASE("compressed_column_matrix - construction_from_entry_initializer_list", "[compressed_column_matrix]")
  {
    Compressed_column_matrix<double> mat{Shape{6, 5}, {
      {Index{2, 2}, 1.0},
      {Index{4, 2}, 2.0},
      {Index{5, 3}, 3.0}
    }};
  ...
  TEST_CASE("compressed_column_matrix - construction_from_sparsity_and_function", "[compressed_column_matrix]")
  {
    Compressed_column_sparsity sp{Shape{6, 5},
      {Index{2, 2}, Index{4, 2}, Index{5, 3}}};

    Compressed_column_matrix<double> mat{sp, [](auto row, auto col) {
  ...
  {
    Compressed_row_matrix<double> csr{Shape{5, 6}, {
      {Index{2, 2}, 1.0},
      {Index{2, 4}, 2.0},
      {Index{3, 5}, 3.0}
    }};
  ...
  {
    Compressed_column_matrix<double> csc{Shape{5, 6}, {
      {Index{2, 2}, 1.0},
      {Index{2, 4}, 2.0},
      {Index{3, 5}, 3.0}
    }};
