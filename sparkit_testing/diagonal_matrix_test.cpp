...
namespace sparkit::testing {
  ...
  TEST_CASE("diagonal_matrix - construction_from_entries", "[diagonal_matrix]")
  {
  ...
  TEST_CASE("diagonal_matrix - tridiagonal_element_access", "[diagonal_matrix]")
  {
    // 4x4 tridiagonal
    Diagonal_matrix<double> mat{Shape{4, 4}, {
      {Index{0, 0}, 2.0}, {Index{0, 1}, -1.0},
      {Index{1, 0}, -1.0}, {Index{1, 1}, 2.0}, {Index{1, 2}, -1.0},
      {Index{2, 1}, -1.0}, {Index{2, 2}, 2.0}, {Index{2, 3}, -1.0},
      {Index{3, 2}, -1.0}, {Index{3, 3}, 2.0}
    }};
