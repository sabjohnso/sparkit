...
namespace sparkit::testing {
  ...
  TEST_CASE("harwell_boeing - read_fortran_reals_d_exponent", "[harwell_boeing]")
  {
  ...
  TEST_CASE("harwell_boeing - read_unsymmetric_real", "[harwell_boeing]")
  {
    ...
    std::istringstream input{
      "Small unsymmetric matrix                                                SMALLUNS\n"
      "             4             1             1             1             0\n"
      "RUA                    3             3             4             0\n"
      "(8I10)          (8I10)          (3E26.18)                        \n"
      "         1         3         4         5\n"
  ...
  TEST_CASE("harwell_boeing - read_empty_stream", "[harwell_boeing]")
  {
    ...
    CHECK_THROWS_AS(
      read_harwell_boeing<double>(input),
      std::runtime_error);
  }
  ...
  TEST_CASE("harwell_boeing - write_produces_valid_header", "[harwell_boeing]")
  {
    Compressed_row_matrix<double> mat{Shape{4, 5}, {
      {Index{0, 0}, 1.0},
      {Index{1, 3}, 2.0},
      {Index{3, 4}, 3.0}
    }};
