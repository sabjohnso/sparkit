...
namespace sparkit::testing {
  ...
  TEST_CASE("jagged_diagonal_matrix - construction_from_entries", "[jagged_diagonal_matrix]")
  {
  ...
  TEST_CASE("jagged_diagonal_matrix - element_access", "[jagged_diagonal_matrix]")
  {
    Jagged_diagonal_matrix<double> mat{Shape{4, 5}, {
      {Index{0, 1}, 1.0},
      {Index{0, 3}, 2.0},
  ...
  TEST_CASE("jagged_diagonal_matrix - empty_matrix", "[jagged_diagonal_matrix]")
  {
