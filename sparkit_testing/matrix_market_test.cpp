...
namespace sparkit::testing {
  ...
  TEST_CASE("matrix_market - parse_banner", "[matrix_market]") {
    auto banner = parse_banner("%%MatrixMarket matrix coordinate real general");
  ...
  TEST_CASE("matrix_market - read_general_real", "[matrix_market]") {
    std::istringstream input{"%%MatrixMarket matrix coordinate real general\n"
                             "3 4 3\n"
                             "1 2 4.5\n"
                             "2 3 7.0\n"
                             "3 1 2.5\n"};
  ...
  TEST_CASE("matrix_market - write_known_matrix", "[matrix_market]") {
    ...
    std::string expected = "%%MatrixMarket matrix coordinate real general\n"
                           "3 4 3\n"
                           "1 2 4.5\n"
                           "2 3 7\n"
                           "3 1 2.5\n";
  ...
  TEST_CASE("matrix_market - read_unsupported_format", "[matrix_market]") {
    std::istringstream input{"%%MatrixMarket matrix array real general\n"
                             "3 3\n"};
