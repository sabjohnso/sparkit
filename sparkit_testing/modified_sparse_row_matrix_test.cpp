...
namespace sparkit::testing {
  ...
  TEST_CASE("modified_sparse_row_matrix - construction_and_accessors", "[modified_sparse_row_matrix]")
  {
    Modified_sparse_row_matrix<double> mat{Shape{4, 4}, {
      {Index{0, 0}, 1.0},
      {Index{1, 3}, 2.0},
      {Index{2, 0}, 3.0},
      {Index{2, 2}, 4.0}
  ...
  TEST_CASE("modified_sparse_row_matrix - element_access", "[modified_sparse_row_matrix]")
  {
    Modified_sparse_row_matrix<double> mat{Shape{4, 4}, {
      {Index{0, 0}, 1.0},
      {Index{1, 3}, 2.0},
  ...
  TEST_CASE("modified_sparse_row_matrix - diagonal_accessor", "[modified_sparse_row_matrix]")
  {
    Modified_sparse_row_matrix<double> mat{Shape{3, 3}, {
      {Index{0, 0}, 10.0},
      {Index{0, 2}, 5.0},
      {Index{1, 1}, 20.0},
      {Index{2, 2}, 30.0}
  ...
  TEST_CASE("modified_sparse_row_matrix - empty_matrix", "[modified_sparse_row_matrix]")
  {
  ...
  {
    Modified_sparse_row_matrix<double> msr{Shape{4, 4}, {
      {Index{0, 0}, 1.0},
      {Index{1, 3}, 2.0},
      {Index{2, 0}, 3.0},
      {Index{2, 2}, 4.0}
