...
namespace sparkit::testing {
  ...
  TEST_CASE("spmv - bsr_mixed_blocks", "[spmv]")
  {
    ...
    Block_sparse_row_matrix<double> A{Shape{4, 4}, 2, 2, {
      {Index{0, 0}, 1.0}, {Index{0, 1}, 2.0}, {Index{0, 2}, 5.0}, {Index{0, 3}, 6.0},
      {Index{1, 0}, 3.0}, {Index{1, 1}, 4.0}, {Index{1, 2}, 7.0}, {Index{1, 3}, 8.0},
      {Index{2, 2}, 9.0}, {Index{2, 3}, 10.0},
      {Index{3, 2}, 11.0}, {Index{3, 3}, 12.0}
    }};
