...
namespace sparkit::testing {
  ...
  TEST_CASE("symmetric_block_sparse_row_sparsity - construction_normalizes_upper_blocks",
            "[symmetric_block_sparse_row_sparsity]")
  {
    // Provide entries in upper-triangle block (0,1) -> normalized to block (1,0)
    Symmetric_block_sparse_row_sparsity sbsr{Shape{4, 4}, 2, 2,
            ...
            "[symmetric_block_sparse_row_sparsity]")
  {
    ...
    Symmetric_block_sparse_row_sparsity sbsr{Shape{6, 6}, 2, 2,
      {Index{0, 0}, Index{1, 1},              // block (0,0)
            ...
            "[symmetric_block_sparse_row_sparsity]")
  {
    ...
    Symmetric_block_sparse_row_sparsity sbsr{Shape{5, 5}, 2, 2,
      {Index{0, 0}, Index{4, 4}}};
  ...
  TEST_CASE("symmetric_block_sparse_row_sparsity - copy_construction",
            "[symmetric_block_sparse_row_sparsity]")
  {
    Symmetric_block_sparse_row_sparsity original{Shape{4, 4}, 2, 2,
      {Index{0, 0}, Index{2, 0}, Index{2, 2}}};
  ...
  TEST_CASE("conversions - sbsr_to_csr_expands",
            "[conversions]")
  {
  ...
  TEST_CASE("conversions - csr_to_sbsr_filters_lower_blocks",
            "[conversions]")
  {
  ...
  TEST_CASE("conversions - csr_sbsr_roundtrip",
            "[conversions]")
  {
    ...
    auto sbsr = sparkit::data::detail::to_symmetric_block_sparse_row(original, 2, 2);
