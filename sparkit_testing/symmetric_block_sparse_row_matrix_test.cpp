...
namespace sparkit::testing {
            ...
            "[symmetric_block_sparse_row_matrix]")
  {
    ...
    Symmetric_block_sparse_row_matrix<double> mat{Shape{4, 4}, 2, 2, {
      {Index{0, 0}, 1.0}, {Index{0, 1}, 2.0},
      {Index{1, 0}, 2.0}, {Index{1, 1}, 3.0},
      {Index{2, 0}, 4.0}, {Index{2, 1}, 5.0},
      {Index{3, 0}, 6.0}, {Index{3, 1}, 7.0},
      {Index{2, 2}, 8.0}, {Index{2, 3}, 9.0},
            ...
            "[symmetric_block_sparse_row_matrix]")
  {
    ...
    // Accessing (0,2) -> block(0,1) -> read from block(1,0) with swapped local indices
    // scalar(0,2): block_row=0, block_col=1 -> stored block(1,0), local_row=0, local_col=0
    //   but transposed: local_row=0, local_col=0 -> stored(0,0) in block(1,0) = 4
  ...
  TEST_CASE("conversions - sbsr_matrix_to_csr_matrix_basic",
            "[conversions]")
  {
    Symmetric_block_sparse_row_matrix<double> sbsr{Shape{4, 4}, 2, 2, {
      {Index{0, 0}, 1.0}, {Index{0, 1}, 2.0},
      {Index{1, 0}, 2.0}, {Index{1, 1}, 3.0},
      {Index{2, 0}, 4.0}, {Index{2, 1}, 5.0},
      {Index{3, 0}, 6.0}, {Index{3, 1}, 7.0},
  ...
  TEST_CASE("conversions - csr_matrix_to_sbsr_matrix_basic",
            "[conversions]")
  {
    // Full symmetric 4x4 matrix
    Compressed_row_matrix<double> csr{Shape{4, 4}, {
      {Index{0, 0}, 1.0}, {Index{0, 1}, 2.0}, {Index{0, 2}, 4.0}, {Index{0, 3}, 6.0},
      {Index{1, 0}, 2.0}, {Index{1, 1}, 3.0}, {Index{1, 2}, 5.0}, {Index{1, 3}, 7.0},
      {Index{2, 0}, 4.0}, {Index{2, 1}, 5.0}, {Index{2, 2}, 8.0}, {Index{2, 3}, 9.0},
      {Index{3, 0}, 6.0}, {Index{3, 1}, 7.0}, {Index{3, 2}, 9.0}, {Index{3, 3}, 10.0}
    }};
  ...
  TEST_CASE("conversions - sbsr_matrix_csr_matrix_roundtrip",
            "[conversions]")
  {
    Symmetric_block_sparse_row_matrix<double> original{Shape{4, 4}, 2, 2, {
      {Index{0, 0}, 1.0}, {Index{0, 1}, 2.0},
      {Index{1, 0}, 2.0}, {Index{1, 1}, 3.0},
      {Index{2, 0}, 4.0}, {Index{2, 1}, 5.0},
      {Index{3, 0}, 6.0}, {Index{3, 1}, 7.0},
    ...
    auto roundtrip = sparkit::data::detail::to_symmetric_block_sparse_row(csr, 2, 2);
